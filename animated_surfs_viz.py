...
eq1 = "np.cos(24*np.sqrt(x**2 + y**2) - 3*time)*0.24"
eq2 = "(np.sin(np.pi*2*x-1.8*time)*np.cos(np.pi*2*y+np.cos(1.8*time)))\
      *0.48"
eq3 = "((x**2 - y**2)/(x**2 + y**2))**(2)*np.cos(6*np.pi*x*y-1.8*time)*0.48"
